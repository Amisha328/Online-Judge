...
exports.getUserProfile = async (req, res) => {
  try {
    ...
    // console.log("Competition problems solved:", competitionProblemsSolved);
    ...
    // console.log("Practice submissions found:", practiceProblems);
    ...
    // console.log("Practice problems solved:", countProblemsSolved);
